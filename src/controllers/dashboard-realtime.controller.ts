...
import { DashboardReportExportCompletedSchema } from '@/validators/dashboard.validators';
...
export class DashboardRealtimeController {
  /**
   * @param exportNotifier - Service responsible for dispatching control panel export completions.
   */
